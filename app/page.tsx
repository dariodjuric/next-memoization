...
function getProduct() {
  return fetch('http://localhost:8080/product/1');
}

const getCachedProduct = cache(getProduct);

export async function generateMetadata() {
  await getProduct().then(() => console.log('API response in generateMetadata'));
...
export default async function Home() {
  cookies().get("dummy");
  await getProduct().then(() => console.log('API response in Home component',));
  await getProduct().then(() => console.log('API response in Home component 2'));
